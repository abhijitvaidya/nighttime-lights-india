...
OUTPUT_DIR = '/Users/abhijit/claude-projects/lights/output'
...
econ = pd.read_csv('/Users/abhijit/claude-projects/lights/data/jk_ladakh_economic_data.csv')
...
ax.axvline(x=5, color='red', linestyle='--', linewidth=1.5, alpha=0.5,
